...
describe('Jump Search Tests', () => {
    ...
    test('Works with strings', () => {
        ...
        expect(jumpSearch('c', array)).to.equal(2)
        expect(jumpSearch('z', array)).to.equal(-1)
    })
})
